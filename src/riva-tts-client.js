var RivaTTS = (() => {
  ...
  // src/riva-tts-client.ts
  var riva_tts_client_exports = {};
  __export(riva_tts_client_exports, {
  ...
  var AudioEncoding = /* @__PURE__ */ ((AudioEncoding2) => {
    ...
    AudioEncoding2[AudioEncoding2["LINEAR_PCM"] = 1] = "LINEAR_PCM";
    AudioEncoding2[AudioEncoding2["FLAC"] = 2] = "FLAC";
    AudioEncoding2[AudioEncoding2["MULAW"] = 3] = "MULAW";
    AudioEncoding2[AudioEncoding2["ALAW"] = 20] = "ALAW";
    return AudioEncoding2;
  })(AudioEncoding || {});

  // gen/riva_tts.ts
  var SynthesizeSpeechRequest$Type = class extends MessageType {
    constructor() {
      super("nvidia.riva.tts.SynthesizeSpeechRequest", [
        {
          no: 1,
          name: "text",
          kind: "scalar",
        ...
        { no: 3, name: "encoding", kind: "enum", T: () => ["nvidia.riva.AudioEncoding", AudioEncoding] },
        {
          no: 4,
          name: "sample_rate_hz",
          kind: "scalar",
      ...
      while (reader.pos < end) {
        ...
        switch (fieldNo) {
          ...
          1:
            ...
            break;
          case /* string language_code */
          2:
            message.languageCode = reader.string();
            break;
          case /* nvidia.riva.AudioEncoding encoding */
          3:
            message.encoding = reader.int32();
            break;
          case /* int32 sample_rate_hz */
          4:
            message.sampleRateHz = reader.int32();
            break;
          case /* string voice_name */
          5:
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.voiceName !== "")
        writer.tag(5, WireType.LengthDelimited).string(message.voiceName);
      let u = options.writeUnknownFields;
      if (u !== false)
  ...
  var SynthesizeSpeechRequest = new SynthesizeSpeechRequest$Type();
  var SynthesizeSpeechResponseMetadata$Type = class extends MessageType {
    constructor() {
      super("nvidia.riva.tts.SynthesizeSpeechResponseMetadata", [
        {
          no: 1,
          name: "text",
          kind: "scalar",
      ...
      while (reader.pos < end) {
        ...
        switch (fieldNo) {
          ...
          1:
            message.text = reader.string();
            break;
          case /* string processed_text */
          2:
            message.processedText = reader.string();
            break;
          case /* repeated float predicted_durations */
          8:
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.processedText !== "")
        writer.tag(2, WireType.LengthDelimited).string(message.processedText);
      if (message.predictedDurations.length) {
        writer.tag(8, WireType.LengthDelimited).fork();
        for (let i = 0; i < message.predictedDurations.length; i++)
          writer.float(message.predictedDurations[i]);
        writer.join();
      }
      let u = options.writeUnknownFields;
      if (u !== false)
  ...
  var SynthesizeSpeechResponseMetadata = new SynthesizeSpeechResponseMetadata$Type();
  var SynthesizeSpeechResponse$Type = class extends MessageType {
    constructor() {
      super("nvidia.riva.tts.SynthesizeSpeechResponse", [
        {
          no: 1,
          name: "audio",
          kind: "scalar",
        ...
        { no: 2, name: "meta", kind: "message", T: () => SynthesizeSpeechResponseMetadata }
      ]);
    }
    create(value) {
      const message = globalThis.Object.create(this.messagePrototype);
      ...
      while (reader.pos < end) {
        ...
        switch (fieldNo) {
          ...
          1:
            ...
            break;
          case /* nvidia.riva.tts.SynthesizeSpeechResponseMetadata meta */
          2:
            message.meta = SynthesizeSpeechResponseMetadata.internalBinaryRead(reader, reader.uint32(), options, message.meta);
            break;
          default:
            let u = options.readUnknownField;
            if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
      ...
      if (message.meta)
        SynthesizeSpeechResponseMetadata.internalBinaryWrite(message.meta, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
      let u = options.writeUnknownFields;
      if (u !== false)
        (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
      return writer;
  ...
  var SynthesizeSpeechResponse = new SynthesizeSpeechResponse$Type();
  var RivaSpeechSynthesis = new ServiceType("nvidia.riva.tts.RivaSpeechSynthesis", [
    { name: "Synthesize", options: {}, I: SynthesizeSpeechRequest, O: SynthesizeSpeechResponse },
    { name: "SynthesizeOnline", serverStreaming: true, options: {}, I: SynthesizeSpeechRequest, O: SynthesizeSpeechResponse }
  ]);

  // gen/riva_tts.client.ts
  var RivaSpeechSynthesisClient = class {
    constructor(_transport) {
      this._transport = _transport;
    }
    _transport;
    typeName = RivaSpeechSynthesis.typeName;
    methods = RivaSpeechSynthesis.methods;
    options = RivaSpeechSynthesis.options;
    /**
     ...
     *
     * @generated from protobuf rpc: Synthesize
     */
     ...
     *
     * @generated from protobuf rpc: SynthesizeOnline
     */
    synthesizeOnline(input, options) {
  ...
  // src/riva-tts-client.ts
  var RivaTTSClient = class {
    client;
    constructor(baseUrl = window.location.origin) {
      const transport = new GrpcWebFetchTransport({ baseUrl });
      this.client = new RivaSpeechSynthesisClient(transport);
    }
    async synthesize(text, voiceName = "English-US.Female-1", sampleRate = 16e3) {
      ...
      const { response } = await this.client.synthesizeOnline(request);
      const chunks = [];
      let totalSamples = 0;
      for await (const chunk of response) {
        if (chunk.audio && chunk.audio.length > 0) {
          const int16 = new Int16Array(chunk.audio.buffer, chunk.audio.byteOffset, chunk.audio.length / 2);
  ...
  return __toCommonJS(riva_tts_client_exports);
})();
